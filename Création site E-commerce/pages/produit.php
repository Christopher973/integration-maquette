        ...
        <main class="produits">
            ...
            <div class="product_container">
                ...
                if (isset($_SESSION['access']) && $_SESSION['access'] == 'oui') {
                    ...
                    $query = "SELECT * FROM CLIENTS WHERE NOMCLIENT = :nc AND PRENOMCLIENT = :pc";
                        ...
                        <div class="product_content">
                            <div class="product_card">
                                <div class="product_img">
                                    <img src="/~SAESYS11/img/' . $leProduit['IDPRODUIT'] . '.png" alt="image du produit">
                                </div>
                                ...
                                <div class="product_btn">
                                    <div class="btn_add btn">
                                    	<form action="/~SAESYS11/include/AjoutAuPanier.php" method="post">
    										<input type="hidden" name="idProduit" value="' . $leProduit['IDPRODUIT'] . '">
    										<input type="hidden" name="idClient" value="' . $idClient . '">
    										<input type="hidden" name="fonction" value="ajoutAuPanier">
    										<input type="hidden" name="url" value="?recherche=' . $_GET['recherche'] . '&tri=' . $_GET['tri'] . '">
                            ...
                            <div class="modal " id="modal' . $i . '">
                                <div class="modal_content">
                                    ...
                                    <div class="left">
                                        <img src="/~SAESYS11/img/' . $leProduit['IDPRODUIT'] . '.png">
                                    </div>
                                    <div class="right">
