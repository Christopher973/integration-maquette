...
<body>
    ...
    <div class="container">
        <form action="../include/TraitPaiement.php" method="POST">
            ...
            <input type="text" minlength="10"maxlength="10" title="Téléphone" name="telephone"placeholder="0610203040"required />
    ...
    this.value = this.value.replace(/[^0-9]/g, "");
     ...
     <script>
        document.getElementsByName("poste")[0].addEventListener("input", function() {
    this.value = this.value.replace(/[^0-9]/g, "");
    });
    </script>
     <script>
        document.getElementsByName("Téléphone")[0].addEventListener("input", function() {
    this.value = this.value.replace(/[^0-9]/g, "");
    });
    </script>
        <script>
